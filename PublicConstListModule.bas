...
Public Const RNG_RT_ALLOCATE As String = "B8"            ' 配点
' 算出設定はD-E列（列挿入はF列以降なので影響を受けない）
Public Const RNG_RT_METHOD As String = "E3"              ' 算出方法
Public Const RNG_RT_PARAM As String = "E4"               ' パラメータ
Public Const RNG_RT_STATUS As String = "E5"              ' 状態（追試中 / 完了 / 反映済み）
